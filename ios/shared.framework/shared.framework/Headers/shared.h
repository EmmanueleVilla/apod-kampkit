...
- (id<SharedMultiplatform_settingsSettings>)component1 __attribute__((swift_name("component1()")));
- (SharedStorage *)doCopySettings:(id<SharedMultiplatform_settingsSettings>)settings __attribute__((swift_name("doCopy(settings:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) id<SharedMultiplatform_settingsSettings> settings __attribute__((swift_name("settings")));
@end;
